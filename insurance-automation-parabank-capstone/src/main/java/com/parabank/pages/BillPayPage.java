...
/**
 * BillPay page helper that attempts multiple common locators and resilient field setting.
 */
        ...
        for (By loc : locators) {
            ...
            for (WebElement el : els) {
                try {
                    ...
                    // If it's a text input/textarea/select — use standard clear/sendKeys
                    ...
                    // If element contains an input/textarea/select descendant — use it
                    ...
                    // Try to derive token from locator and search globally for matching input
                    ...
                    // Last resort: try JS to find nearest input inside same parent and set value
